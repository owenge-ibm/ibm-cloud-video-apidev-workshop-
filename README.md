IBM Cloud-based project to showcase IBM Cloud Video API usage. Show how to use the API to list your channels, upload videos and manage an embedded video player.
